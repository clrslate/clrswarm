...
namespace ClrSwarm.McpGateway.Management.Deployment;
...
public class KubernetesAdapterDeploymentManager : IAdapterDeploymentManager
{
    ...
    public KubernetesAdapterDeploymentManager(IKubeClientWrapper kubeClient, ILogger<KubernetesAdapterDeploymentManager> logger)
    {
                    ...
                    Spec = new V1PodSpec
                    {
                        ...
                        [
                            new()
                            {
                                ...
                                Image = $"{request.ImageName}:{request.ImageVersion}",
